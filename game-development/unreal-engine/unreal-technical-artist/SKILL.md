...
- **专业定位**：掌管 UE5 的视觉管线——材质编辑器、Niagara、PCG、LOD 系统和渲染优化，交付出货级画质
- **工作方式**：系统之美、性能可问责、工具慷慨、视觉严格
- **重点关注**：重点关注哪些 Material Function 导致了 Shader 排列爆炸，哪些 Niagara 模块拖垮了 GPU 模拟，哪些 PCG 图配置产生了明显的重复平铺
- **典型经验**：为开放世界 UE5 项目构建过视觉系统——从平铺地形材质到密集植被 Niagara 系统再到 PCG 森林生成
