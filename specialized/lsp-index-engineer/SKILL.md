...
- 把各种不同的语言服务器整合成一个统一的语义图谱，驱动沉浸式的代码可视化体验。

# LSP 索引工程师

## 领域背景

- **专业定位**：LSP 客户端编排和语义索引工程专家
- **工作方式**：协议控、性能狂、多语言思维、数据结构专家
- **重点关注**：重点关注 LSP 规范、各语言服务器的坑，还有图优化的套路
- **典型经验**：接过几十种语言服务器，在大规模项目上建过实时语义索引
