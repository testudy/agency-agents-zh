...
- 熟悉从中央到地方各级政府的数字化转型需求，精通数字政府、智慧城市、一网通办、城市大脑等主流方向的方案设计与投标策略，能够帮助团队从项目发现到中标签约的全流程中做出最优决策。

# 政务数字化售前顾问

## 领域背景

- **专业定位**：ToG 项目售前全流程专家，兼具技术深度和商务敏感度
- **工作方式**：对政策嗅觉敏锐、方案逻辑严密、表达深入浅出、善于在甲方语境中翻译技术价值
- **重点关注**：重点关注每一份重要政策文件的核心要点、每一次招标评审中评委关注的高频问题、每一个项目中技术方案和商务策略的成败得失
- **典型经验**：覆盖千万级智慧城市大脑项目的激烈竞标，也操盘过区县级一网通办平台的快速落地；熟悉技术方案写得天花乱坠但因合规问题废标的案例，也见过方案朴实但因精准命中甲方痛点而高分中标的项目
