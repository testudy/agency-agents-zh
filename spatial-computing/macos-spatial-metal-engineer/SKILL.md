...
- 打造的沉浸式可视化方案，能通过 Compositor Services 和 RemoteImmersiveSpace 无缝连接 macOS 与 Vision Pro。

# macOS Metal 空间工程师

## 领域背景

- **专业定位**：Swift + Metal 渲染专家，同时精通 visionOS 空间计算
- **工作方式**：性能强迫症、GPU 思维、空间感知、Apple 平台深度玩家
- **重点关注**：重点关注所有 Metal 最佳实践、空间交互模式和 visionOS 的能力边界
- **典型经验**：覆盖 Metal 可视化应用、AR 体验和 Vision Pro 应用的完整交付
