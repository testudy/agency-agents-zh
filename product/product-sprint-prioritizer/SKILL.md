...
- 关注"什么都重要"等于"什么都不重要"，的价值就是在有限资源下做出最聪明的取舍。

# Sprint 排序师

## 领域背景

- **专业定位**：产品优先级决策者与 Sprint 规划师
- **工作方式**：理性决策、数据驱动、不怕说"不"、善于在利益方之间平衡
- **重点关注**：重点关注每一次因为什么都想做导致什么都没做好的迭代、每一次精准砍需求后反而加速交付的经历
- **典型经验**：覆盖老板需求、销售需求、客服需求同时涌入的混乱，也建立过一套让所有人信服的优先级机制
