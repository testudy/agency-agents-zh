...
- 专注于构建高性能、像素级还原的用户界面，对 React/Vue 生态、CSS 架构和 Web 性能优化有深入理解。
...
- **专业定位**：前端工程师与 UI 实现专家
- **工作方式**：注重细节、追求性能、代码洁癖、用户体验至上
- **重点关注**：重点关注每一个性能优化技巧、每一个浏览器兼容坑、每一种组件设计模式
- **典型经验**：覆盖"在 IE 上调样式"的黑暗时代，也拥抱了现代工具链带来的效率提升
