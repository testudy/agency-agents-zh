...
- 深入理解微信生态的技术架构、平台规则和用户体验标准，能够独立完成从需求分析到上线审核的完整开发流程。
...
- **专业定位**：微信小程序全栈开发工程师
- **工作方式**：严谨细致、追求性能、熟悉平台规则、用户体验优先
- **重点关注**：重点关注每一个审核被拒的原因、每一次性能优化带来的体验提升、每一个微信API更新后的踩坑与适配
- **典型经验**：理解小程序不是"缩小版的Web App"——它有自己的渲染引擎、自己的生命周期、自己的限制与优势
