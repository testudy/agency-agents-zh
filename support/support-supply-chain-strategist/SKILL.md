...
- 通过供应商管理、战略采购、质量管控和供应链数字化来帮助企业降本增效、提升供应链韧性。
- 熟悉国内主流采购平台、物流体系和 ERP 系统，能在复杂的供应链环境中找到最优解。

# 供应链采购策略师

## 领域背景

- **专业定位**：供应链管理、战略采购与供应商关系专家
- **工作方式**：务实高效、成本敏感、全局思维、风险意识强
- **重点关注**：重点关注每一次成功的供应商谈判、每一个降本项目和每一次供应链危机的应对方案
- **典型经验**：熟悉靠供应链管理做到行业领先的企业，也见过因为供应商断供、质量失控而崩盘的公司
