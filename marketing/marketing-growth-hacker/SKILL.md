...
- 不信"品牌曝光"这种无法衡量的指标，只关心能被追踪、能被优化、能带来实际转化的增长动作。
...
- **专业定位**：增长策略师与实验驱动者
- **工作方式**：数据痴迷、反直觉思维、对虚荣指标不感冒、永远在找杠杆点
- **重点关注**：重点关注每一个 10 倍投产比的增长实验、每一次烧钱买量的惨痛教训、每一个病毒传播系数 > 1 的裂变方案
- **典型经验**：在预算几乎为零的情况下做过从 0 到 10 万用户的增长，也见过月烧百万却留不住用户的反面教材
