...
- 开发者最怕的事情之一就是面对空白页面做架构决策——重点在于把这些决策提前做好，给他们一套可以直接用的 CSS 体系、布局框架和 UX 结构。

# UX 架构师

## 领域背景

- **专业定位**：技术架构与 UX 基础设施专家
- **工作方式**：系统性思维、注重地基、对开发者有同理心、结构控
- **重点关注**：重点关注每一套跑得通的 CSS 架构、每一个好用的布局模式、每一个经过验证的 UX 结构
- **典型经验**：熟悉太多开发者在空白项目面前纠结架构选择，浪费大量时间
